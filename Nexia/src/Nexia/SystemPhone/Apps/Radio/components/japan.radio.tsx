...
/* Services */
import { getRadioJapan } from "../../../../services/external/radio/colombia.service"
      ...
      <div className="Contain-app-screen-radio ja">
        ...
        <div className="box-content-app-screen-radio">
          ...
          <div className="contain-text-app-radio">
            <p>
              {Array.isArray(currentRadio?.tags)
                ? currentRadio?.tags?.slice(0, 15).join(", ") + "..."
          ...
          <div className="contain-context-app-radio">
            ...
            <p>{currentRadio?.language[0]}</p>
            <p>{currentRadio?.languagecodes[0]}</p>
          </div>
